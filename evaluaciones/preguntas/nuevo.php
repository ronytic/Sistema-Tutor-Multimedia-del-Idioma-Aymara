    	...
    	<div class="prefix_0 grid_11 alpha">
			<fieldset>
				...
				<table class="tablareg">
                    ...
                    <tr>
						<td><?php campos("Respuesta Nº 1","opcion1","text","",1,array("required"=>"required","size"=>30));?></td>
                        <td><?php campos("Respuesta Nº 2","opcion2","text","",1,array("required"=>"required","size"=>30));?></td>
                        <td><?php campos("Respuesta Nº 3","opcion3","text","",1,array("required"=>"required","size"=>30));?></td>
                    </tr>
                    <tr>
                        <td><?php campos("Respuesta Nº 4","opcion4","text","",1,array("required"=>"required","size"=>30));?></td>
                        <td><?php campos("Respuesta Nº 5","opcion5","text","",1,array("required"=>"required","size"=>30));?></td>
					</tr>
